  ...
  return (
    <section className="projects" ref={scrollTab}>
      ...
      <div className="des" ref={(el) => el && divs.current.push(el)}>
        {/* 20 */}I have worked on a variety of projects that showcase my
        ability to build full-stack web applications. My projects typically
        involve creating dynamic and scalable back-end APIs using Node.js and
        Express, while leveraging MongoDB for data storage and management. On
        the front-end, I use React to build interactive, user-friendly
        interfaces with efficient state management and responsive designs.
      </div>
      <div className="list">
